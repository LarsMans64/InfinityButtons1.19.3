...
public class RecipeGen extends FabricRecipeProvider {
    ...
    protected void generateStickyCopperButton(Consumer<RecipeJsonProvider> i, ItemConvertible out, ItemConvertible in, ItemConvertible largeOut, ItemConvertible largeIn) {
        ShapelessRecipeJsonBuilder.create(RecipeCategory.REDSTONE, out).input(in).input(Items.HONEYCOMB).criterion("has_thing", RecipeProvider.conditionsFromItem(Items.COPPER_INGOT)).offerTo(i);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.REDSTONE,largeOut).input(largeIn).input(Items.HONEYCOMB).criterion("has_thing", RecipeProvider.conditionsFromItem(Items.COPPER_INGOT)).offerTo(i, CraftingRecipeJsonBuilder.getItemId(largeOut) + "_waxing");
    ...
    protected void generateSecretButton(Consumer<RecipeJsonProvider> i, ItemConvertible out, ItemConvertible in) {
        ShapelessRecipeJsonBuilder.create(RecipeCategory.REDSTONE, out).input(in).input(Items.STONE_BUTTON).group("secret_button").criterion("has_thing", RecipeProvider.conditionsFromItem(in)).offerTo(i);
    }
    ...
    protected void generateEmergencyButton(Consumer<RecipeJsonProvider> i, ItemConvertible out, ItemConvertible dye, ItemConvertible safe) {
        ShapelessRecipeJsonBuilder.create(RecipeCategory.REDSTONE, out).input(dye).input(Items.STONE_BUTTON).group("emergency_button").criterion("has_thing", RecipeProvider.conditionsFromItem(dye)).offerTo(i);
